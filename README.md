...
```groovy
compile "org.alfresco:alfresco-acs-java-rest-api-spring-boot-starter:6.0.0-SNAPSHOT"
compile "org.alfresco:alfresco-java-event-api-spring-boot-starter:6.0.0-SNAPSHOT"
```
