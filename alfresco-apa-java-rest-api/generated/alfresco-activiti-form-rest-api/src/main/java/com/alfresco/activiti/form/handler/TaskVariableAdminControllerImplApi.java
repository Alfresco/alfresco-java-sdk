...
@Api(value = "TaskVariableAdminControllerImpl")
public interface TaskVariableAdminControllerImplApi {
    ...
    ResponseEntity<Void> createVariableUsingPOST(@ApiParam(value = "createTaskVariablePayload" ,required=true )  @Valid @RequestBody CreateTaskVariablePayload createTaskVariablePayload,@ApiParam(value = "taskId",required=true) @PathVariable("taskId") String taskId);
