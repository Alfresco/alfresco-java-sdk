...
@Api(value = "ProcessInstanceAdminControllerImpl")
public interface ProcessInstanceAdminControllerImplApi {
    ...
    ResponseEntity<Void> receiveUsingPUT(@ApiParam(value = "receiveMessagePayload" ,required=true )  @Valid @RequestBody ReceiveMessagePayload receiveMessagePayload);
    ...
    @RequestMapping(value = "/admin/v1/process-instances",
        ...
        consumes = "application/json",
        method = RequestMethod.POST)
    ResponseEntity<EntryResponseContentCloudProcessInstance> startProcessUsingPOST(@ApiParam(value = "startProcessPayload" ,required=true )  @Valid @RequestBody StartProcessPayload startProcessPayload);
    ...
    @RequestMapping(value = "/admin/v1/process-instances/message",
        ...
        consumes = "application/json",
        method = RequestMethod.POST)
    ResponseEntity<EntryResponseContentCloudProcessInstance> startUsingPOST(@ApiParam(value = "startMessagePayload" ,required=true )  @Valid @RequestBody StartMessagePayload startMessagePayload);
    ...
    @RequestMapping(value = "/admin/v1/process-instances/{processInstanceId}",
        ...
        consumes = "application/json",
        method = RequestMethod.PUT)
    ResponseEntity<EntryResponseContentCloudProcessInstance> updateProcessUsingPUT(@ApiParam(value = "payload" ,required=true )  @Valid @RequestBody UpdateProcessPayload payload,@ApiParam(value = "processInstanceId",required=true) @PathVariable("processInstanceId") String processInstanceId);
