...
import com.alfresco.activiti.form.model.CreateProcessInstancePayload;
import com.alfresco.activiti.form.model.EntryResponseContentCloudProcessInstance;
import com.alfresco.activiti.form.model.ListResponseContentCloudProcessInstance;
import com.alfresco.activiti.form.model.ReceiveMessagePayload;
import com.alfresco.activiti.form.model.SignalPayload;
import com.alfresco.activiti.form.model.StartMessagePayload;
import com.alfresco.activiti.form.model.StartProcessPayload;
import com.alfresco.activiti.form.model.UpdateProcessPayload;
...
@Api(value = "ProcessInstanceControllerImpl")
public interface ProcessInstanceControllerImplApi {
    ...
    ResponseEntity<EntryResponseContentCloudProcessInstance> createProcessInstanceUsingPOST(@ApiParam(value = "createProcessInstancePayload" ,required=true )  @Valid @RequestBody CreateProcessInstancePayload createProcessInstancePayload);
    ...
    ResponseEntity<Void> receiveUsingPUT1(@ApiParam(value = "receiveMessagePayload" ,required=true )  @Valid @RequestBody ReceiveMessagePayload receiveMessagePayload);
    ...
    @RequestMapping(value = "/v1/process-instances/signal",
        ...
        consumes = "application/json",
        method = RequestMethod.POST)
    ResponseEntity<Void> sendSignalUsingPOST(@ApiParam(value = "cmd" ,required=true )  @Valid @RequestBody SignalPayload cmd);
    ...
    @RequestMapping(value = "/v1/process-instances/message",
        ...
        consumes = "application/json",
        method = RequestMethod.POST)
    ResponseEntity<EntryResponseContentCloudProcessInstance> sendStartMessageUsingPOST(@ApiParam(value = "startMessagePayload" ,required=true )  @Valid @RequestBody StartMessagePayload startMessagePayload);
    ...
    @RequestMapping(value = "/v1/process-instances/{processInstanceId}/start",
        ...
        consumes = "application/json",
        method = RequestMethod.POST)
    ResponseEntity<EntryResponseContentCloudProcessInstance> startCreatedProcessUsingPOST(@ApiParam(value = "processInstanceId",required=true) @PathVariable("processInstanceId") String processInstanceId,@ApiParam(value = "startProcessPayload"  )  @Valid @RequestBody StartProcessPayload startProcessPayload);
    ...
    @RequestMapping(value = "/v1/process-instances",
        ...
        consumes = "application/json",
        method = RequestMethod.POST)
    ResponseEntity<EntryResponseContentCloudProcessInstance> startProcessUsingPOST1(@ApiParam(value = "startProcessPayload" ,required=true )  @Valid @RequestBody StartProcessPayload startProcessPayload);
    ...
    @RequestMapping(value = "/v1/process-instances/{processInstanceId}",
        ...
        consumes = "application/json",
        method = RequestMethod.PUT)
    ResponseEntity<EntryResponseContentCloudProcessInstance> updateProcessUsingPUT1(@ApiParam(value = "payload" ,required=true )  @Valid @RequestBody UpdateProcessPayload payload,@ApiParam(value = "processInstanceId",required=true) @PathVariable("processInstanceId") String processInstanceId);
