...
public interface ProjectsApi {
    ...
    @RequestMapping(value = "/v1/projects",
        ...
        method = RequestMethod.POST)
    ResponseEntity<EntryResponseContentProject> createProjectUsingPOST(@ApiParam(value = "The details of the project to create" ,required=true )  @Valid @RequestBody Project project);
    ...
    @RequestMapping(value = "/v1/projects/import",
        ...
        method = RequestMethod.POST)
    ResponseEntity<EntryResponseContentProject> importProjectUsingPOST(@ApiParam(value = "The file containing the zipped project" ,required=true )  @Valid @RequestBody byte[] file,@ApiParam(value = "" ) @RequestParam(value="name", required=false)  String name);
    ...
    ResponseEntity<EntryResponseContentProject> updateProjectUsingPUT(@ApiParam(value = "The new values to update" ,required=true )  @Valid @RequestBody Project project,@ApiParam(value = "The id of the project to update",required=true) @PathVariable("projectId") String projectId);
