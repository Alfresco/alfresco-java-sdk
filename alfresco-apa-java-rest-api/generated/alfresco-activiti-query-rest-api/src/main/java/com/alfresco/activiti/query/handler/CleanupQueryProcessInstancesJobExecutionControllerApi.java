...
import com.alfresco.activiti.query.model.CleanupQueryProcessInstancesJobRequest;
...
@Api(value = "CleanupQueryProcessInstancesJobExecutionController")
public interface CleanupQueryProcessInstancesJobExecutionControllerApi {
    ...
    ResponseEntity<EntryResponseContentOfJobExecution> launchUsingPOST(@ApiParam(value = "launchRequest" ,required=true )  @Valid @RequestBody CleanupQueryProcessInstancesJobRequest launchRequest);
