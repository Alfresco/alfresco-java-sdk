...
@Api(value = "CandidateUserAdminControllerImpl")
public interface CandidateUserAdminControllerImplApi {
    ...
    ResponseEntity<Void> addCandidateUsersUsingPOST(@ApiParam(value = "candidateUsersPayload" ,required=true )  @Valid @RequestBody CandidateUsersPayload candidateUsersPayload,@ApiParam(value = "taskId",required=true) @PathVariable("taskId") String taskId);
    ...
    ResponseEntity<Void> deleteCandidateUsersUsingDELETE(@ApiParam(value = "candidateUsersPayload" ,required=true )  @Valid @RequestBody CandidateUsersPayload candidateUsersPayload,@ApiParam(value = "taskId",required=true) @PathVariable("taskId") String taskId);
