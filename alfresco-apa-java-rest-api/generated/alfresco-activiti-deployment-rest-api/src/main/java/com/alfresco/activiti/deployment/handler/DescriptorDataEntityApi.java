...
@Api(value = "DescriptorDataEntity")
public interface DescriptorDataEntityApi {
    ...
    ResponseEntity<EntryResponseContentDescriptor> descriptorDataDescriptorUsingPATCH(@ApiParam(value = "body" ,required=true )  @Valid @RequestBody String body,@ApiParam(value = "id",required=true) @PathVariable("id") String id);
    ...
    ResponseEntity<EntryResponseContentDescriptor> descriptorDataDescriptorUsingPOST(@ApiParam(value = "body" ,required=true )  @Valid @RequestBody String body,@ApiParam(value = "id",required=true) @PathVariable("id") String id);
    ...
    ResponseEntity<EntryResponseContentDescriptor> descriptorDataDescriptorUsingPUT(@ApiParam(value = "body" ,required=true )  @Valid @RequestBody String body,@ApiParam(value = "id",required=true) @PathVariable("id") String id);
