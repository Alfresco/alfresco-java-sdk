...
@Api(value = "DeploymentController")
public interface DeploymentControllerApi {
    ...
    ResponseEntity<Void> createApplicationUsingPOST(@ApiParam(value = "applicationRepresentation" ,required=true )  @Valid @RequestBody ApplicationRepresentation applicationRepresentation);
    ...
    @ApiOperation(value = "Retrieve the application runtime version by id.", nickname = "getApplicationRuntimeVersionUsingGET", notes = "", response = String.class, tags={ "deployment-controller", })
    @ApiResponses(value = { 
    ...
    ResponseEntity<String> getApplicationRuntimeVersionUsingGET(@ApiParam(value = "ID of application which runtime version is queried",required=true) @PathVariable("id") String id);
    ...
    @ApiOperation(value = "Retrieve the latest runtime version available in the deployment service.", nickname = "getLatestRuntimeVersionUsingGET", notes = "", response = String.class, tags={ "deployment-controller", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = String.class),
        @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 403, message = "Forbidden"),
    ...
    @RequestMapping(value = "/deployment-service/v1/applications/runtime-versions/latest",
        produces = "*/*", 
        method = RequestMethod.GET)
    ResponseEntity<String> getLatestRuntimeVersionUsingGET();


    @ApiOperation(value = "Retrieve a list of runtime versions available in the deployment service.", nickname = "getRuntimeVersionsUsingGET", notes = "", response = String.class, responseContainer = "List", tags={ "deployment-controller", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = String.class, responseContainer = "List"),
        @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 403, message = "Forbidden"),
    ...
    @RequestMapping(value = "/deployment-service/v1/applications/runtime-versions",
        produces = "*/*", 
        method = RequestMethod.GET)
    ResponseEntity<List<String>> getRuntimeVersionsUsingGET(@ApiParam(value = "versionEqualOrLater") @Valid @RequestParam(value = "versionEqualOrLater", required = false) String versionEqualOrLater);
    ...
    ResponseEntity<Void> upgradeApplicationUsingPUT(@ApiParam(value = "applicationPutRequestRepresentation" ,required=true )  @Valid @RequestBody ApplicationPutRequestRepresentation applicationPutRequestRepresentation,@ApiParam(value = "ID of application to update",required=true) @PathVariable("id") String id);
