...
import com.alfresco.activiti.preference.model.ListResponseContentPreference;
...
public interface PreferenceApi {
    ...
    ResponseEntity<ResponseEntity> savePreferenceUsingPUT(@ApiParam(value = "The Key of the preference to be created",required=true) @PathVariable("preferenceKey") String preferenceKey,@ApiParam(value = "preferenceValue" ,required=true )  @Valid @RequestBody String preferenceValue);
