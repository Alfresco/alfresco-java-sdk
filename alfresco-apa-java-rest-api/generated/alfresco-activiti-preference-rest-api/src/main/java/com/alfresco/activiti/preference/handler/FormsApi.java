...
import com.alfresco.activiti.preference.model.SaveFormRepresentation;
import com.alfresco.activiti.preference.model.SubmitFormRepresentation;
...
public interface FormsApi {
    ...
    ResponseEntity<Void> saveFormUsingPOST(@ApiParam(value = "The id of the form instance to be saved",required=true) @PathVariable("formId") String formId,@ApiParam(value = "saveFormRepresentation" ,required=true )  @Valid @RequestBody SaveFormRepresentation saveFormRepresentation);
    ...
    @RequestMapping(value = "/v1/forms/{formId}/submit",
        ...
        consumes = "application/json",
        method = RequestMethod.POST)
    ResponseEntity<ResponseEntity> submitFormUsingPOST1(@ApiParam(value = "The id of the form to be submitted",required=true) @PathVariable("formId") String formId,@ApiParam(value = "submitFormRepresentation" ,required=true )  @Valid @RequestBody SubmitFormRepresentation submitFormRepresentation);
