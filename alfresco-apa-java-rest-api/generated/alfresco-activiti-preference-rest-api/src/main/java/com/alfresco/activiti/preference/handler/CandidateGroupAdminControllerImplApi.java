...
@Api(value = "CandidateGroupAdminControllerImpl")
public interface CandidateGroupAdminControllerImplApi {
    ...
    ResponseEntity<Void> addCandidateGroupsUsingPOST(@ApiParam(value = "candidateGroupsPayload" ,required=true )  @Valid @RequestBody CandidateGroupsPayload candidateGroupsPayload,@ApiParam(value = "taskId",required=true) @PathVariable("taskId") String taskId);
    ...
    ResponseEntity<Void> deleteCandidateGroupsUsingDELETE(@ApiParam(value = "candidateGroupsPayload" ,required=true )  @Valid @RequestBody CandidateGroupsPayload candidateGroupsPayload,@ApiParam(value = "taskId",required=true) @PathVariable("taskId") String taskId);
