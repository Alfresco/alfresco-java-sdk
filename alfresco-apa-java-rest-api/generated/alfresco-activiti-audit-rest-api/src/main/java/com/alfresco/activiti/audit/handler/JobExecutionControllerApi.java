...
import com.alfresco.activiti.audit.model.EntryResponseContentOfJobExecution;
import com.alfresco.activiti.audit.model.InputStreamResource;
import com.alfresco.activiti.audit.model.JobConfig;
import com.alfresco.activiti.audit.model.ListResponseContentOfJobExecution;
...
@Api(value = "JobExecutionController")
public interface JobExecutionControllerApi {
    ...
    ResponseEntity<EntryResponseContentOfJobExecution> postUsingPOST(@ApiParam(value = "jobConfig" ,required=true )  @Valid @RequestBody JobConfig jobConfig);
