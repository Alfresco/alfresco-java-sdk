...
import org.alfresco.activiti.preference.model.AssignTaskPayload;
import org.alfresco.activiti.preference.model.CompleteTaskPayload;
import org.alfresco.activiti.preference.model.EntryResponseContentOfCloudTask;
import org.alfresco.activiti.preference.model.ListResponseContentOfCloudTask;
import org.alfresco.activiti.preference.model.UpdateTaskPayload;
...
public interface TaskAdminControllerImplApi {
    ...
    @CollectionFormat(feign.CollectionFormat.CSV)
    ResponseEntity<EntryResponseContentOfCloudTask> updateTaskUsingPUT(@ApiParam(value = "taskId", required=true) @PathVariable("taskId") String taskId, @ApiParam(value = "" ) @Valid @RequestBody UpdateTaskPayload body);
