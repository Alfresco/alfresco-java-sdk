...
public class EntryResponseContentOfApplicationResponseRepresentation   {
  @JsonProperty("entry")
  private ApplicationResponseRepresentation entry = null;

  public EntryResponseContentOfApplicationResponseRepresentation entry(ApplicationResponseRepresentation entry) {
    this.entry = entry;
    return this;
  }
  ...
  public String toString() {
    ...
    sb.append("class EntryResponseContentOfApplicationResponseRepresentation {\n");
