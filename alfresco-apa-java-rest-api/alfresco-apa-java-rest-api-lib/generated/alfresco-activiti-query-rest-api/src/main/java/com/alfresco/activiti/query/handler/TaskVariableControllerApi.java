...
@Api(value = "TaskVariableController", description = "the TaskVariableController API")
public interface TaskVariableControllerApi {

    @ApiOperation(value = "getVariables", nickname = "getVariablesUsingGET3", notes = "", response = ListResponseContentOfCloudVariableInstance.class, tags={ "task-variable-controller", })
    @ApiResponses(value = { 
