# alfresco-activiti-modeling-rest-api
...
```groovy
compile "org.alfresco:alfresco-activiti-modeling-rest-api:5.1.2-SNAPSHOT"
```
...
* target/alfresco-activiti-modeling-rest-api-5.1.2-SNAPSHOT.jar
* target/lib/*.jar
...
```java
  import org.alfresco.activiti.modeling.*;
  import org.alfresco.activiti.modeling.auth.*;
  import org.alfresco.activiti.modeling.model.*;
