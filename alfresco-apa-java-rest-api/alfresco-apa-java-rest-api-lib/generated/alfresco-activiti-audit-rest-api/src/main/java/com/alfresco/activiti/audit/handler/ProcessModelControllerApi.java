...
@Api(value = "ProcessModelController", description = "the ProcessModelController API")
public interface ProcessModelControllerApi {

    @ApiOperation(value = "getProcessModel", nickname = "getProcessModelUsingGET1", notes = "", response = String.class, tags={ "process-model-controller", })
    @ApiResponses(value = { 
