...
import com.alfresco.activiti.audit.model.ListResponseContentOfCloudProcessInstance;
...
@Api(value = "ProcessInstanceController", description = "the ProcessInstanceController API")
public interface ProcessInstanceControllerApi {

    @ApiOperation(value = "findAll", nickname = "findAllUsingGET7", notes = "", response = ListResponseContentOfCloudProcessInstance.class, tags={ "process-instance-controller", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "findById", nickname = "findByIdUsingGET2", notes = "", response = EntryResponseContentOfCloudProcessInstance.class, tags={ "process-instance-controller", })
    @ApiResponses(value = { 
    ...
    @RequestMapping(value = "/v1/process-instances/{processInstanceId}",
        produces = "application/json", 
        method = RequestMethod.GET)
    ResponseEntity<EntryResponseContentOfCloudProcessInstance> findByIdUsingGET2(@ApiParam(value = "processInstanceId", required=true) @PathVariable("processInstanceId") String processInstanceId);


    @ApiOperation(value = "subprocesses", nickname = "subprocessesUsingGET", notes = "", response = ListResponseContentOfCloudProcessInstance.class, tags={ "process-instance-controller", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK", response = ListResponseContentOfCloudProcessInstance.class),
        @ApiResponse(code = 401, message = "Unauthorized"),
        @ApiResponse(code = 403, message = "Forbidden"),
