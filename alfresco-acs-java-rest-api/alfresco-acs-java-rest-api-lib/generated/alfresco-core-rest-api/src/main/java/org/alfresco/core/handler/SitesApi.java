...
public interface SitesApi {
    ...
    @ApiResponses(value = { 
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    @RequestMapping(value = "/sites/{siteId}/group-members",
        produces = "application/json", 
        consumes = "application/json",
        method = RequestMethod.POST)
    @CollectionFormat(feign.CollectionFormat.CSV)
    ...
    @ApiOperation(value = "Delete a group membership for site", nickname = "deleteSiteGroupMembership", notes = "**Note:** this endpoint is available in Alfresco 7.0.0 and newer versions.  Deletes group **groupId** as a member of site **siteId**. ", authorizations = {
        @Authorization(value = "basicAuth")
    }, tags={ "sites", })
    @ApiResponses(value = { 
        @ApiResponse(code = 204, message = "Successful response"),
        ...
        @ApiResponse(code = 200, message = "Unexpected error", response = Error.class) })
    @RequestMapping(value = "/sites/{siteId}/group-members/{groupId}",
        produces = "application/json", 
        consumes = "",
        method = RequestMethod.DELETE)
    @CollectionFormat(feign.CollectionFormat.CSV)
    ...
    @ApiOperation(value = "Get information about site membership of group", nickname = "getSiteGroupMembership", notes = "**Note:** this endpoint is available in Alfresco 7.0.0 and newer versions.  Gets site membership information for group **groupId** on site **siteId**. ", response = SiteGroupEntry.class, authorizations = {
        @Authorization(value = "basicAuth")
    }, tags={ "sites", })
    @ApiResponses(value = { 
    ...
    @ApiOperation(value = "List group membership for site", nickname = "listSiteGroups", notes = "**Note:** this endpoint is available in Alfresco 7.0.0 and newer versions.  Gets a list of group membership for site **siteId**. ", response = SiteGroupPaging.class, authorizations = {
        @Authorization(value = "basicAuth")
    }, tags={ "sites", })
    @ApiResponses(value = { 
