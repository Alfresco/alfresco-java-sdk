...
public abstract class AbstractNodeResource implements Resource {
    ...
    public AbstractNodeResource(final String id) {
        this(id, null);
    }

    public AbstractNodeResource(final String id, final List<String> primaryHierarchy) {
        this.id = id;
    ...
    public boolean equals(final Object o) {
        ...
        final AbstractNodeResource resource = (AbstractNodeResource) o;
