...
/**
 * Unit tests for {@link IsFolderFilter}.
 */
public class IsFolderFilterTest {

    private final IsFolderFilter isFolderFilter = IsFolderFilter.get();

    @Test
    public void should_testTrue_when_folderEventIsSent() {
