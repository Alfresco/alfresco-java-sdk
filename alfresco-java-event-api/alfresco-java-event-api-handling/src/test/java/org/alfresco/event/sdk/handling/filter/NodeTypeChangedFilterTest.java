...
/**
 * Unit tests for {@link NodeTypeChangedFilter}.
 */
public class NodeTypeChangedFilterTest {

    private final NodeTypeChangedFilter nodeTypeChangedFilter = NodeTypeChangedFilter.get();

    @Test
    public void should_testTrue_when_nodeTypeChangedEventIsSent() {
        final NodeResource nodeResource = NodeResource.builder()
                .setNodeType("test:after")
                .build();
        final NodeResource nodeBeforeResource = NodeResource.builder()
                .setNodeType("test:before")
                .build();
    ...
    @Test
    public void should_testFalse_when_eventWithoutNodeTypeChangeIsSent() {
        final NodeResource nodeResource = NodeResource.builder()
                .setNodeType("test:type")
                .build();
        final NodeResource nodeBeforeResource = NodeResource.builder()
                .setNodeType("test:type")
                .build();
