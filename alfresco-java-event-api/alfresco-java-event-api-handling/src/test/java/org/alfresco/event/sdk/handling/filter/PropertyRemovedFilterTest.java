...
/**
 * Unit tests for {@link PropertyRemovedFilter}.
 */
public class PropertyRemovedFilterTest {

    private static final String TEST_PROPERTY = "test:prop";
    private static final String TEST_VALUE = "value";

    private final PropertyRemovedFilter propertyRemovedFilter = PropertyRemovedFilter.of(TEST_PROPERTY);

    @Test
    public void should_testTrue_when_propertyRemovedEventIsSent() {
        ...
        final boolean result = propertyRemovedFilter.test((RepoEvent<DataAttributes<Resource>>) repoEvent);

        assertThat(result).isTrue();
    }

    @Test
    public void should_testFalse_when_eventWithoutPropertyRemovedIsSent() {
        final NodeResource nodeResource = NodeResource.builder()
            .setProperties(Map.of(TEST_PROPERTY, TEST_VALUE))
            .build();
        final NodeResource nodeBeforeResource = NodeResource.builder()
