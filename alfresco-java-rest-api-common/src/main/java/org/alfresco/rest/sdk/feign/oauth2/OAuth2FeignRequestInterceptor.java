...
public class OAuth2FeignRequestInterceptor implements RequestInterceptor {
    ...
    private OAuth2AuthorizedClient getAuthorizedClient() {
        try {
            return authorizedClientService.loadAuthorizedClient(
                    ...
                    oAuth2AuthorizeRequest.getPrincipal().getName()
            );
        } catch (Exception e) {
    ...
    private OAuth2AuthorizedClient refreshAccessToken(OAuth2AuthorizedClient client) {
        try {
            ...
            OAuth2AuthorizeRequest refreshRequest = OAuth2AuthorizeRequest.withClientRegistrationId(client.getClientRegistration().getRegistrationId())
