...
- `alfresco.base-url`
- `spring.security.oauth2.client.registration.alfresco-rest-api.client-id`
- `spring.security.oauth2.client.registration.alfresco-rest-api.client-secret`
- `spring.security.oauth2.client.provider.alfresco.token-uri`
