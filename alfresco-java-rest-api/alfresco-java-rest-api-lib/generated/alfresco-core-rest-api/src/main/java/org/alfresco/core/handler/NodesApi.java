...
@ApiParam(value = "The targetParentId and, optionally, a new name which should include the file extension." ,required=true )  @Valid @RequestBody NodeBodyCopy nodeBodyCopy
...
@ApiParam(value = "A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter. ") @Valid @RequestParam(value = "fields", required = false) List<String>
 fields
    ...
    @RequestMapping(value = "/nodes/{nodeId}/targets",
        ...
        consumes = "application/json",
        method = RequestMethod.POST)
    ResponseEntity<AssociationEntry
> createAssociation(


@ApiParam(value = "The identifier of a source node.",required=true) @PathVariable("nodeId") String
 nodeId
...
@ApiParam(value = "The target node id and assoc type." ,required=true )  @Valid @RequestBody AssociationBody associationBodyCreate
...
@ApiParam(value = "The identifier of a node. You can also use one of these well-known aliases: * -my- * -shared- * -root- ",required=true) @PathVariable("nodeId") String
 nodeId
...
@ApiParam(value = "The node information to create." ,required=true )  @Valid @RequestBody NodeBodyCreate nodeBodyCreate
...
@ApiParam(value = "A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter. ") @Valid @RequestParam(value = "fields", required = false) List<String>
 fields
    ...
    @RequestMapping(value = "/nodes/{nodeId}/secondary-children",
        ...
        consumes = "application/json",
        method = RequestMethod.POST)
    ResponseEntity<ChildAssociationEntry
> createSecondaryChildAssociation(


@ApiParam(value = "The identifier of a parent node.",required=true) @PathVariable("nodeId") String
 nodeId
...
@ApiParam(value = "The child node id and assoc type." ,required=true )  @Valid @RequestBody ChildAssociationBody secondaryChildAssociationBodyCreate
...
@ApiParam(value = "The identifier of a target node.",required=true) @PathVariable("targetId") String
 targetId
...
@ApiParam(value = "Only delete associations of this type.") @Valid @RequestParam(value = "assocType", required = false) String
 assocType
...
@ApiParam(value = "If **true** then the node is deleted permanently, without moving to the trashcan. Only the owner of the node or an admin can permanently delete the node. ", defaultValue = "false") @Valid @RequestParam(value = "permanent", required = false, defaultValue="false") Boolean
 permanent
...
@ApiParam(value = "The identifier of a child node.",required=true) @PathVariable("childId") String
 childId
...
@ApiParam(value = "A path relative to the **nodeId**. If you set this,  information is returned on the node resolved by this path. ") @Valid @RequestParam(value = "relativePath", required = false) String
 relativePath
...
@ApiParam(value = "The Range header indicates the part of a document that the server should return. Single part request supported, for example: bytes=1-10. " ) @RequestHeader(value="Range", required=false) String
 range
    ...
    @RequestMapping(value = "/nodes/{nodeId}/children",
        ...
        consumes = "",
        method = RequestMethod.GET)
    ResponseEntity<NodeChildAssociationPaging
> listNodeChildren(
...
@ApiParam(value = "Optionally filter the list. Here are some examples:  *   ```where=(isFolder=true)```  *   ```where=(isFile=true)```  *   ```where=(nodeType='my:specialNodeType')```  *   ```where=(nodeType='my:specialNodeType INCLUDESUBTYPES')```  *   ```where=(isPrimary=true)```  *   ```where=(assocType='my:specialAssocType')```  *   ```where=(isPrimary=false and assocType='my:specialAssocType')``` ") @Valid @RequestParam(value = "where", required = false) String
 where
...
@ApiParam(value = "Return information on children in the folder resolved by this path. The path is relative to **nodeId**.") @Valid @RequestParam(value = "relativePath", required = false) String
 relativePath
...
@ApiParam(value = "Also include **source** in addition to **entries** with folder information on the parent node – either the specified parent **nodeId**, or as resolved by **relativePath**.") @Valid @RequestParam(value = "includeSource", required = false) Boolean
 includeSource
...
@ApiParam(value = "A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter. ") @Valid @RequestParam(value = "fields", required = false) List<String>
 fields
    ...
    @RequestMapping(value = "/nodes/{nodeId}/parents",
        ...
        consumes = "",
        method = RequestMethod.GET)
    ResponseEntity<NodeAssociationPaging
> listParents(


@ApiParam(value = "The identifier of a child node. You can also use one of these well-known aliases: * -my- * -shared- * -root- ",required=true) @PathVariable("nodeId") String
 nodeId
...
@ApiParam(value = "Optionally filter the list by **assocType** and/or **isPrimary**. Here are some example filters:  *   ```where=(assocType='my:specialAssocType')```  *   ```where=(isPrimary=true)```  *   ```where=(isPrimary=false and assocType='my:specialAssocType')``` ") @Valid @RequestParam(value = "where", required = false) String
 where
...
@ApiParam(value = "Also include **source** (in addition to **entries**) with folder information on **nodeId**") @Valid @RequestParam(value = "includeSource", required = false) Boolean
 includeSource
...
@ApiParam(value = "The identifier of a parent node. You can also use one of these well-known aliases: * -my- * -shared- * -root- ",required=true) @PathVariable("nodeId") String
 nodeId
...
@ApiParam(value = "Optionally filter the list by assocType. Here's an example:  *   ```where=(assocType='my:specialAssocType')``` ") @Valid @RequestParam(value = "where", required = false) String
 where
...
@ApiParam(value = "The identifier of a target node.",required=true) @PathVariable("nodeId") String
 nodeId
...
@ApiParam(value = "Lock details." ,required=true )  @Valid @RequestBody NodeBodyLock nodeBodyLock
...
@ApiParam(value = "The targetParentId and, optionally, a new name which should include the file extension." ,required=true )  @Valid @RequestBody NodeBodyMove nodeBodyMove
...
@ApiParam(value = "The node information to update." ,required=true )  @Valid @RequestBody NodeBodyUpdate nodeBodyUpdate
...
@ApiParam(value = "If **true**, create a major version. Setting this parameter also enables versioning of this node, if it is not already versioned. ", defaultValue = "false") @Valid @RequestParam(value = "majorVersion", required = false, defaultValue="false") Boolean
 majorVersion
...
@ApiParam(value = "Add a version comment which will appear in version history. Setting this parameter also enables versioning of this node, if it is not already versioned. ") @Valid @RequestParam(value = "comment", required = false) String
 comment
...
@ApiParam(value = "Optional new name. This should include the file extension. The name must not contain spaces or the following special characters: * \" < > \\ / ? : and |.  The character `.` must not be used at the end of the name.  ") @Valid @RequestParam(value = "name", required = false) String
 name
