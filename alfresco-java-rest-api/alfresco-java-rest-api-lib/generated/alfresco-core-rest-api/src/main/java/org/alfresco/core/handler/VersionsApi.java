...
@ApiParam(value = "The identifier of a version, ie. version label, within the version history of a node.",required=true) @PathVariable("versionId") String
 versionId
...
@ApiParam(value = "Returns additional information about the version node. The following optional fields can be requested: * properties * aspectNames ") @Valid @RequestParam(value = "include", required = false) List<String>
 include
...
@ApiParam(value = "Optionally, specify a version comment and whether this should be a major version, or not." ,required=true )  @Valid @RequestBody RevertBody revertBody
