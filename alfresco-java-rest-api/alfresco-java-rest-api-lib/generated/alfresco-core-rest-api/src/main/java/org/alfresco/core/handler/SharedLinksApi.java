...
public interface SharedLinksApi {
    ...
    ResponseEntity<SharedLinkEntry
> createSharedLink(


@ApiParam(value = "The nodeId to create a shared link for." ,required=true )  @Valid @RequestBody SharedLinkBodyCreate sharedLinkBodyCreate

,

@ApiParam(value = "Returns additional information about the shared link, the following optional fields can be requested: * allowableOperations * path * properties * isFavorite * aspectNames ") @Valid @RequestParam(value = "include", required = false) List<String>
 include
...
@ApiParam(value = "The shared link email to send." ,required=true )  @Valid @RequestBody SharedLinkBodyEmail sharedLinkBodyEmail
...
@ApiParam(value = "The identifier of a shared link to a file.",required=true) @PathVariable("sharedId") String
 sharedId
    ...
    @RequestMapping(value = "/shared-links",
        ...
        consumes = "",
        method = RequestMethod.GET)
    ResponseEntity<SharedLinkPaging
> listSharedLinks(@Min(0)
...
@ApiParam(value = "Optionally filter the list by \"sharedByUser\" userid of person who shared the link (can also use -me-)  *   ```where=(sharedByUser='jbloggs')```  *   ```where=(sharedByUser='-me-')``` ") @Valid @RequestParam(value = "where", required = false) String
 where
