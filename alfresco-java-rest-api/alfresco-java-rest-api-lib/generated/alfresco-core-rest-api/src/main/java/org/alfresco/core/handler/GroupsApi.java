...
public interface GroupsApi {
    ...
    ResponseEntity<GroupEntry
> createGroup(


@ApiParam(value = "The group to create." ,required=true )  @Valid @RequestBody GroupBodyCreate groupBodyCreate

,

@ApiParam(value = "Returns additional information about the group. The following optional fields can be requested: * parentIds * zones ") @Valid @RequestParam(value = "include", required = false) List<String>
 include
...
@ApiParam(value = "A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter. ") @Valid @RequestParam(value = "fields", required = false) List<String>
 fields
    ...
    @RequestMapping(value = "/groups/{groupId}/members",
        ...
        consumes = "application/json",
        method = RequestMethod.POST)
    ResponseEntity<GroupMemberEntry
> createGroupMembership(


@ApiParam(value = "The identifier of a group.",required=true) @PathVariable("groupId") String
 groupId
...
@ApiParam(value = "The group membership to add (person or sub-group)." ,required=true )  @Valid @RequestBody GroupMembershipBodyCreate groupMembershipBodyCreate
...
@ApiParam(value = "If **true** then the delete will be applied in cascade to sub-groups. ", defaultValue = "false") @Valid @RequestParam(value = "cascade", required = false, defaultValue="false") Boolean
 cascade
...
@ApiParam(value = "The identifier of a person or group.",required=true) @PathVariable("groupMemberId") String
 groupMemberId
...
@ApiParam(value = "A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter. ") @Valid @RequestParam(value = "fields", required = false) List<String>
 fields
    ...
    @RequestMapping(value = "/groups/{groupId}/members",
        ...
        consumes = "",
        method = RequestMethod.GET)
    ResponseEntity<GroupMemberPaging
...
@ApiParam(value = "The group information to update." ,required=true )  @Valid @RequestBody GroupBodyUpdate groupBodyUpdate
