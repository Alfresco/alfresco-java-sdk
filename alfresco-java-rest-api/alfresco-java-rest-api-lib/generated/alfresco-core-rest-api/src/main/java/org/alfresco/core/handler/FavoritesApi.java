...
@ApiParam(value = "An object identifying the entity to be favorited.   The object consists of a single property which is an object with the name `site`, `file`, or `folder`.  The content of that object is the `guid` of the target entity.  For example, to favorite a file the following body would be used:  ```JSON {    \"target\": {       \"file\": {          \"guid\": \"abcde-01234-....\"       }    } } ``` " ,required=true )  @Valid @RequestBody FavoriteBodyCreate favoriteBodyCreate

,

@ApiParam(value = "Returns additional information about favorites, the following optional fields can be requested: * path (note, this only applies to files and folders) * properties ") @Valid @RequestParam(value = "include", required = false) List<String>
 include
...
@ApiParam(value = "A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter. ") @Valid @RequestParam(value = "fields", required = false) List<String>
 fields
    ...
    @RequestMapping(value = "/people/{personId}/favorite-sites",
        ...
        consumes = "application/json",
        method = RequestMethod.POST)
    ResponseEntity<FavoriteSiteEntry
> createSiteFavorite(
...
@ApiParam(value = "The id of the site to favorite." ,required=true )  @Valid @RequestBody FavoriteSiteBodyCreate favoriteSiteBodyCreate
...
@ApiParam(value = "The identifier of a favorite.",required=true) @PathVariable("favoriteId") String
 favoriteId
