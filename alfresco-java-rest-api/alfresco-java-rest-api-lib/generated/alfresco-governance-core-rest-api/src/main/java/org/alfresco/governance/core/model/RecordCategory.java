...
public class RecordCategory   {
  ...
  public RecordCategory id(String id) {
    this.id = id;
    return this;
  }
  ...
  **/
  ...
  public RecordCategory parentId(String parentId) {
  ...
  **/
  ...
  public RecordCategory name(String name) {
    this.name = name;
    return this;
  }
...
@Pattern(regexp="^(?!(.*[\\\"\\*\\\\\\>\\<\\?/\\:\\|]+.*)|(.*[\\.]?.*[\\.]+$)|(.*[ ]+$))") 
  ...
  public RecordCategory nodeType(String nodeType) {
  ...
  **/
  ...
  public RecordCategory hasRetentionSchedule(Boolean hasRetentionSchedule) {
  ...
  **/
  ...
  public RecordCategory modifiedAt(OffsetDateTime modifiedAt) {
  ...
  **/
  ...
  public RecordCategory modifiedByUser(UserInfo modifiedByUser) {
  ...
  **/
  ...
  public RecordCategory createdAt(OffsetDateTime createdAt) {
  ...
  **/
  ...
  public RecordCategory createdByUser(UserInfo createdByUser) {
  ...
  **/
  ...
  public RecordCategory aspectNames(List<String> aspectNames) {
    this.aspectNames = aspectNames;
    return this;
  }

  public RecordCategory addAspectNamesItem(String aspectNamesItem) {
  ...
  **/
  ...
  public RecordCategory properties(Object properties) {
  ...
  **/
  ...
  public RecordCategory allowableOperations(List<String> allowableOperations) {
    this.allowableOperations = allowableOperations;
    return this;
  }

  public RecordCategory addAllowableOperationsItem(String allowableOperationsItem) {
  ...
  **/
  ...
  public RecordCategory path(PathInfo path) {
    this.path = path;
    return this;
  }
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    RecordCategory recordCategory = (RecordCategory) o;
    return Objects.equals(this.id, recordCategory.id) &&
        Objects.equals(this.parentId, recordCategory.parentId) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(id, parentId, name, nodeType, hasRetentionSchedule, modifiedAt, modifiedByUser, createdAt, createdByUser, aspectNames, properties, allowableOperations, path);
  }
