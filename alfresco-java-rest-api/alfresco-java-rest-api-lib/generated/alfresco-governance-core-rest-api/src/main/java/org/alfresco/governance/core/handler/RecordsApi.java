...
@ApiParam(value = "The identifier of a record.",required=true) @PathVariable("recordId") String
 recordId
...
@ApiParam(value = "The target record folder id" ,required=true )  @Valid @RequestBody RequestBodyFile nodeBodyFile
...
@ApiParam(value = "The record information to update." ,required=true )  @Valid @RequestBody FilePlanComponentBodyUpdate recordBodyUpdate
