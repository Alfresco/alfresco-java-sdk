...
@ApiParam(value = "The identifier of a file plan. You can also use the -filePlan- alias.",required=true) @PathVariable("filePlanId") String
 filePlanId
...
@ApiParam(value = "The node information to create." ,required=true )  @Valid @RequestBody RootCategoryBodyCreate nodeBodyCreate
...
@ApiParam(value = "Returns additional information about the file plan. Any optional field from the response model can be requested. For example: * allowableOperations * path ") @Valid @RequestParam(value = "include", required = false) List<String>
 include
...
@ApiParam(value = "A list of field names.  You can use this parameter to restrict the fields returned within a response if, for example, you want to save on overall bandwidth.  The list applies to a returned individual entity or entries within a collection.  If the API method also supports the **include** parameter, then the fields specified in the **include** parameter are returned in addition to those specified in the **fields** parameter. ") @Valid @RequestParam(value = "fields", required = false) List<String>
 fields
    ...
    @RequestMapping(value = "/file-plans/{filePlanId}/categories",
        ...
        consumes = "",
        method = RequestMethod.GET)
    ResponseEntity<RecordCategoryPaging
...
@ApiParam(value = "Returns additional information about the record category. Any optional field from the response model can be requested. For example: * allowableOperations * aspectNames * hasRetentionSchedule * path * properties ") @Valid @RequestParam(value = "include", required = false) List<String>
 include
...
@ApiParam(value = "Also include **source** (in addition to **entries**) with folder information on the parent node – the specified parent **filePlanId**") @Valid @RequestParam(value = "includeSource", required = false) Boolean
 includeSource
...
@ApiParam(value = "The file plan information to update." ,required=true )  @Valid @RequestBody FilePlanBodyUpdate filePlanBodyUpdate
