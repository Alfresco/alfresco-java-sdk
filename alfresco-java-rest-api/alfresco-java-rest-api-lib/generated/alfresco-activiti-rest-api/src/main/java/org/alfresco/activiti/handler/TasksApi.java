...
@ApiParam(value = "tasksFilter" ,required=true )  @Valid @RequestBody TaskFilterRequestRepresentation tasksFilter
...
@ApiParam(value = "taskId",required=true) @PathVariable("taskId") String
 taskId
    ...
    @RequestMapping(value = "/enterprise/tasks/{taskId}/audit",
        ...
        consumes = "",
        method = RequestMethod.GET)
    ResponseEntity<TaskAuditInfoRepresentation
...
@ApiParam(value = "queryRequest" ,required=true )  @Valid @RequestBody HistoricTaskInstanceQueryRepresentation queryRequest
...
@ApiParam(value = "tasksQuery" ,required=true )  @Valid @RequestBody TaskQueryRepresentation tasksQuery
...
@ApiParam(value = "updated" ,required=true )  @Valid @RequestBody TaskUpdateRepresentation updated
