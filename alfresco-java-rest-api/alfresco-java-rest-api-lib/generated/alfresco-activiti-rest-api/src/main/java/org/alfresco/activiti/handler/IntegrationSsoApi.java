...
public interface IntegrationSsoApi {
    ...
    @RequestMapping(value = "/enterprise/integration/sso/confirm-auth-request",
        produces = "text/html", 
        consumes = "",
    ...
    @RequestMapping(value = "/enterprise/integration/sso/{repositoryId}/account",
        produces = "*/*", 
        consumes = "",
