...
public interface IntegrationDriveApi {
    ...
    }, tags={ "integration-drive", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "OK") })
    @RequestMapping(value = "/enterprise/integration/google-drive/confirm-auth-request",
        produces = "text/html", 
        consumes = "",
    ...
    @RequestMapping(value = "/enterprise/integration/google-drive/files",
