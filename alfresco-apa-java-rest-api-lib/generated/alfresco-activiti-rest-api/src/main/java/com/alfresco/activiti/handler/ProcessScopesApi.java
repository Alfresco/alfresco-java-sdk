...
import com.alfresco.activiti.model.ProcessScopeRepresentation;
import com.alfresco.activiti.model.ProcessScopesRequestRepresentation;
...
public interface ProcessScopesApi {
    ...
    ResponseEntity<List<ProcessScopeRepresentation>> getRuntimeProcessScopesUsingPOST(@ApiParam(value = "" ) @Valid @RequestBody ProcessScopesRequestRepresentation body);
