...
import com.alfresco.activiti.model.DecisionTableExpressionRepresentation;
import com.alfresco.activiti.model.VariableScopeRepresentation;
...
public class DecisionTableDefinitionRepresentation   {
  ...
  public DecisionTableDefinitionRepresentation rules(List<Map<String, Object>> rules) {
    this.rules = rules;
    return this;
  }

  public DecisionTableDefinitionRepresentation addRulesItem(Map<String, Object> rulesItem) {
    if (this.rules == null) {
